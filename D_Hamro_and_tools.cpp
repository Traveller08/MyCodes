...
vl parent(100105),curr_size(100105),arr(100105);
void make_set(int v) {
    parent[v] = v;
    curr_size[v]=v;
}
...
void union_sets(int a, int b) {
 parent[find_set(a)]=parent[find_set(b)];
}
...
void solve()
    {
        ni2(n,q);
        mll mpp;
        rep(i,0,n+10,1)make_set(i);
        rep(i,0,q,1){
            ni2(l,r);
            ll s=curr_size[l],t=curr_size[r];
            curr_size[l]=0;
            if(t!=0)union_sets(l,r);
            else curr_size[r]=s;
        }
       
        rep(i,1,n+1,1)arr[curr_size[i]]=i;
      //  rep(i,1,n+1,1)cout<<parent[i]<<" ";cout<<endl;
        rep(i,1,n+1,1)cout<<arr[find_set(i)]<<" ";
    }
