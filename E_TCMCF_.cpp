...
void solve()
    {
       ...
       if(neg_size==1){
         ...
         else if(neg_size==0 and pos_size==0)cout<<0<<endl;
         sort(all(neg));
       
        rep(i,0,pos_size,1)cout<<pos[i]<<" ";
           
        if((neg_size%2)==0){
            rep(i,0,neg_size,1)cout<<neg[i]<<" ";
        }
        else {
           rep(i,0,neg_size-1,1)cout<<neg[i]<<" ";
         }
