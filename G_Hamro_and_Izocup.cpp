...
ld areaofsegment(ld r, ll a){
   ld theta=double(a)/double(2*r);
        ld sininv=asin(theta);
        ld area=sininv*double(r)*r;
        ld area_triangle=findArea(r,r,a);
        ld ans=area-area_triangle;
        return ans;
}
void solve()
    {
        ni3(a,r1,r2);
        ld ans1=areaofsegment(r1,a);
        ld ans2=areaofsegment(r2,a);
        ld ans=ans1+ans2;
