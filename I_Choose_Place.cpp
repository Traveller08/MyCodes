...
void solve()
    {
       char mat[6][8];
       rep(i,0,6,1){
           rep(j,0,8,1)cin>>mat[i][j];
       }
       map<ll,vector<pll>>pos;
       pos[1].pb(mp(0,3)); pos[1].pb(mp(0,4)); pos[1].pb(mp(1,3)); pos[1].pb(mp(1,4));
       pos[2].pb(mp(0,0)); pos[2].pb(mp(0,1)); pos[2].pb(mp(2,3)); pos[2].pb(mp(2,4)); pos[2].pb(mp(0,6)); pos[2].pb(mp(0,7));
        pos[2].pb(mp(1,0)); pos[2].pb(mp(1,1)); pos[2].pb(mp(3,3)); pos[2].pb(mp(3,4)); pos[2].pb(mp(1,6)); pos[2].pb(mp(1,7));

         pos[3].pb(mp(0+2,0)); pos[3].pb(mp(0+2,1)); pos[3].pb(mp(2+2,3)); pos[3].pb(mp(2+2,4)); pos[3].pb(mp(0+2,6)); pos[3].pb(mp(0+2,7));
        pos[3].pb(mp(1+2,0)); pos[3].pb(mp(1+2,1)); pos[3].pb(mp(3+2,3)); pos[3].pb(mp(3+2,4)); pos[3].pb(mp(1+2,6)); pos[3].pb(mp(1+2,7));
        
         pos[4].pb(mp(0+2+2,0)); pos[4].pb(mp(0+2+2,1)); pos[4].pb(mp(0+2+2,6)); pos[4].pb(mp(0+2+2,7));
         pos[4].pb(mp(1+2+2,0)); pos[4].pb(mp(1+2+2,1)); pos[4].pb(mp(1+2+2,6)); pos[4].pb(mp(1+2+2,7));
         bool found=0;
         for(auto c:pos){
             vector<pll>tp=c.yt;
             for(auto x:tp){
           ...
           rep(i,0,6,1){
           rep(j,0,8,1)cout<<mat[i][j];cout<<endl;
       }
    }
